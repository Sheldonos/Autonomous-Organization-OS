...
1. **SKILL.md body** - When skill triggers (<500 lines)

1. **Bundled resources** - As needed
...
1. Plan reusable skill contents (scripts, references, templates)

1. Initialize the skill (run init_skill.py)

1. Edit the skill (implement resources and write SKILL.md)

1. Deliver the skill (send SKILL.md path via notify_user)
...
1. Package the skill directory into a `.skill` file

1. Send to frontend as a special card with options:
  - Add to My Skills
  - Download
  - Preview
