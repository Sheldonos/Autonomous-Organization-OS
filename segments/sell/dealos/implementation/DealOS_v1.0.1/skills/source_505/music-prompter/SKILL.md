...
1. **Soundscape/Ambiance & Space**: Background sounds, overall sonic environment, and spatial characteristics such as reverb type, stereo width, and perceived distance.
...
1. **Production Quality**: Desired audio fidelity, recording style, and spatial production choices.
...
1. **Core DNA**: Describe the Genre, Mood, Instrumentation, Density, Soundscape, and Production Quality. This establishes the overall sonic picture.
  - *Example*: `The feeling is nostalgic, introspective, and atmospheric. The sound should be centered around a warm Fender Rhodes...`

1. **Arrangement Breakdown (Optional)**: If you need precise control, provide a chronological breakdown. **CRITICAL**: If you use timestamps, the final timestamp MUST exactly match the total duration declared in step 1.
